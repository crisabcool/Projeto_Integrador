					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="depto" name="depto" placeholder="Depto" >    
							</div> 	
						</div>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="atendimento" name="atendimento" placeholder="Atendimento" >    
							</div> 	
						</div>
